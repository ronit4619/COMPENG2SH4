...
*/
    ...
    void TestQ3_low_boundary(CuTest *tc) {
...
//=================Question 7================================  
    ...
    CuSuite* Lab1GetSuite() {
        ...
        SUITE_ADD_TEST(suite, TestQ2_float);
        ...
        SUITE_ADD_TEST(suite, TestQ3_low_boundary);
