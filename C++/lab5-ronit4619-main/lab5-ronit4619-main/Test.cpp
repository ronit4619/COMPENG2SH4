...
void testSLLSetIntArray_new() {

        int arr[] = {1, 3, 6, 7, 9}; // this list

        SLLSet listObj2 = SLLSet(arr,5);
        string expectedSet = "1, 3, 6, 7, 9";
        int expectedSize = 5;
        ASSERT_EQUAL(expectedSize,listObj2.getSize());
        ASSERT_EQUAL(expectedSet,listObj2.toString());
	}
...
void testCopy_new() {
		...
		SLLSet copied = listObj2.copy();
        copied.add(100);
        string expectedObj2 = "1, 3, 6, 7, 9";
        string expectedCopied = "1, 3, 6, 7, 9, 100";
        int expectedObj2Size = 5;
        int expectedCopiedSize = 6;
...
void testRemove_new() {
    ...
    SLLSet listObj2 =  SLLSet(arr,5);
        ...
        int removeo = 1;  // test remove
        int removed = 2;
        //test remove

        listObj2.remove(removeo);
        listObj2.remove(removed);

        string expectedObj2 = "3, 7, 8";
...
void testDifference1_new() {

	      // parameters inpt here

    int arr[] = {1, 3, 4, 6}; // this list
...
void testUnionSLLSetArray_new() {

        int arr1[] = {0, 2};
        int arr2[] = {3, 4, 5};
        int arr3[] = {6 };
        int arr4[] = {7, 8, 9};
        SLLSet listObj100 = SLLSet(arr1,2);
        SLLSet listObj99 = SLLSet(arr2,3);
        SLLSet listObj98 = SLLSet(arr3,1);
...
//test cases with "_new" are newly added"
    s.push_back(CUTE(testSLLSet));
    s.push_back(CUTE(testSLLSetIntArray));
    s.push_back(CUTE(testSLLSetIntArray_new));
    s.push_back(CUTE(testCopy));
    s.push_back(CUTE(testCopy_new));
    ...
    s.push_back(CUTE(testDifference1_new));
    ...
    s.push_back(CUTE(testUnionSLLSetArray_new));
